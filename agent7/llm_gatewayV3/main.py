...
async def embed(request: Request):
    """Embed endpoint — Session 7.
    Returns a 768-dim vector. Primary: Ollama nomic-embed-text.
    Fallback: Gemini gemini-embedding-001 with outputDimensionality=768.
    Both providers return the same 768-dim space so they share one FAISS index.
    """
    ...
    # Fallback: Gemini gemini-embedding-001
